...
const App = () => {
  ...
  // fetch five location suggestion and update on ui
  ...
  // this funtion will prevent form submission vaidates city and fetchwes data via api key
